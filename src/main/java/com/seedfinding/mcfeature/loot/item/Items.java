...
public class Items {
	...
	public static final Item ACACIA_BOAT_WITH_CHEST = register(new Item("acacia_boat_with_chest"));
	...
	public static final Item ACACIA_HANGING_SIGN = register(new Item("acacia_hanging_sign"));
	...
	public static final Item ACACIA_WALL_HANGING_SIGN = register(new Item("acacia_wall_hanging_sign"));
	public static final Item ACACIA_WALL_SIGN = register(new Item("acacia_wall_sign"));
	...
	public static final Item ALLAY_SPAWN_EGG = register(new Item("allay_spawn_egg"));
	...
	public static final Item ANGLER_POTTERY_SHERD = register(new Item("angler_pottery_sherd"));
	public static final Item ANVIL = register(new Item("anvil"));
	public static final Item APPLE = register(new Item("apple"));
	public static final Item ARCHER_POTTERY_SHERD = register(new Item("archer_pottery_sherd"));
	...
	public static final Item BAMBOO_BLOCK = register(new Item("bamboo_block"));
	public static final Item BAMBOO_BUTTON = register(new Item("bamboo_button"));
	public static final Item BAMBOO_DOOR = register(new Item("bamboo_door"));
	public static final Item BAMBOO_FENCE = register(new Item("bamboo_fence"));
	public static final Item BAMBOO_FENCE_GATE = register(new Item("bamboo_fence_gate"));
	public static final Item BAMBOO_HANGING_SIGN = register(new Item("bamboo_hanging_sign"));
	public static final Item BAMBOO_MOSAIC = register(new Item("bamboo_mosaic"));
	public static final Item BAMBOO_MOSAIC_SLAB = register(new Item("bamboo_mosaic_slab"));
	public static final Item BAMBOO_MOSAIC_STAIRS = register(new Item("bamboo_mosaic_stairs"));
	public static final Item BAMBOO_PLANKS = register(new Item("bamboo_planks"));
	public static final Item BAMBOO_PRESSURE_PLATE = register(new Item("bamboo_pressure_plate"));
	public static final Item BAMBOO_RAFT = register(new Item("bamboo_raft"));
	public static final Item BAMBOO_RAFT_WITH_CHEST = register(new Item("bamboo_raft_with_chest"));
	public static final Item BAMBOO_SAPLING = register(new Item("bamboo_sapling"));
	public static final Item BAMBOO_SIGN = register(new Item("bamboo_sign"));
	...
	public static final Item BANNER_PATTERN_SKULL_CHARGE = register(new Item("banner_pattern_skull_charge"));
	public static final Item BANNER_PATTERN_SNOUT = register(new Item("banner_pattern_snout"));
	public static final Item BANNER_PATTERN_THING = register(new Item("banner_pattern_thing"));
	...
	public static final Item BIRCH_HANGING_SIGN = register(new Item("birch_hanging_sign"));
	...
	public static final Item BLACK_CANDLE_CAKE = register(new Item("black_candle_cake"));
	...
	public static final Item BLADE_POTTERY_SHERD = register(new Item("blade_pottery_sherd"));
	...
	public static final Item BLUE_CANDLE_CAKE = register(new Item("blue_candle_cake"));
	...
	public static final Item BOOK_AND_QUILL = register(new Item("book_and_quill"));
	public static final Item BOOKSHELF = register(new Item("bookshelf"));
	public static final Item BOTTLE_O_ENCHANTING = register(new Item("bottle_o_enchanting"));
	...
	public static final Item BROWN_CANDLE_CAKE = register(new Item("brown_candle_cake"));
	...
	public static final Item BRUSH = register(new Item("brush"));
	public static final Item BUBBLE_COLUMN = register(new Item("bubble_column"));
	...
	public static final Item BUCKET_OF_PUFFERFISH = register(new Item("bucket_of_pufferfish"));
	public static final Item BUCKET_OF_SALMON = register(new Item("bucket_of_salmon"));
	public static final Item BUCKET_OF_TADPOLE = register(new Item("bucket_of_tadpole"));
	public static final Item BUCKET_OF_TROPICAL_FISH = register(new Item("bucket_of_tropical_fish"));
	...
	public static final Item BURN_POTTERY_SHERD = register(new Item("burn_pottery_sherd"));
	...
	public static final Item CALIBRATED_SCULK_SENSOR = register(new Item("calibrated_sculk_sensor"));
	public static final Item CAMEL_SPAWN_EGG = register(new Item("camel_spawn_egg"));
	public static final Item CAMPFIRE = register(new Item("campfire"));
	public static final Item CANDLE = register(new Item("candle"));
	public static final Item CANDLE_CAKE = register(new Item("candle_cake"));
	...
	public static final Item CARROTS = register(new Item("carrots"));
	...
	public static final Item CHERRY_BOAT = register(new Item("cherry_boat"));
	public static final Item CHERRY_BOAT_WITH_CHEST = register(new Item("cherry_boat_with_chest"));
	public static final Item CHERRY_BUTTON = register(new Item("cherry_button"));
	public static final Item CHERRY_DOOR = register(new Item("cherry_door"));
	public static final Item CHERRY_FENCE = register(new Item("cherry_fence"));
	public static final Item CHERRY_FENCE_GATE = register(new Item("cherry_fence_gate"));
	public static final Item CHERRY_HANGING_SIGN = register(new Item("cherry_hanging_sign"));
	public static final Item CHERRY_LEAVES = register(new Item("cherry_leaves"));
	public static final Item CHERRY_LOG = register(new Item("cherry_log"));
	public static final Item CHERRY_PLANKS = register(new Item("cherry_planks"));
	public static final Item CHERRY_PRESSURE_PLATE = register(new Item("cherry_pressure_plate"));
	public static final Item CHERRY_SAPLING = register(new Item("cherry_sapling"));
	public static final Item CHERRY_SIGN = register(new Item("cherry_sign"));
	...
	public static final Item CHISELED_BOOKSHELF = register(new Item("chiseled_bookshelf"));
	public static final Item CHISELED_COPPER = register(new Item("chiseled_copper"));
	...
	public static final Item CHISELED_TUFF = register(new Item("chiseled_tuff"));
	...
	public static final Item COCOA = register(new Item("cocoa"));
	...
	public static final Item COPPER_BULB = register(new Item("copper_bulb"));
	public static final Item COPPER_DOOR = register(new Item("copper_door"));
	public static final Item COPPER_GRATE = register(new Item("copper_grate"));
	...
	public static final Item COPPER_TRAPDOOR = register(new Item("copper_trapdoor"));
	...
	public static final Item CRAFTER = register(new Item("crafter"));
	...
	public static final Item CRIMSON_HANGING_SIGN = register(new Item("crimson_hanging_sign"));
	...
	public static final Item CYAN_CANDLE_CAKE = register(new Item("cyan_candle_cake"));
	...
	public static final Item DANGER_POTTERY_SHERD = register(new Item("danger_pottery_sherd"));
	public static final Item DARK_OAK_BOAT = register(new Item("dark_oak_boat"));
	public static final Item DARK_OAK_BOAT_WITH_CHEST = register(new Item("dark_oak_boat_with_chest"));
	...
	public static final Item DARK_OAK_HANGING_SIGN = register(new Item("dark_oak_hanging_sign"));
	...
	public static final Item DISC_FRAGMENT = register(new Item("disc_fragment"));
	...
	public static final Item ECHO_SHARD = register(new Item("echo_shard"));
	...
	public static final Item EMPTY_MAP = register(new Item("empty_map"));
	...
	public static final Item END_GATEWAY = register(new Item("end_gateway"));
	public static final Item END_PORTAL = register(new Item("end_portal"));
	...
	public static final Item ENDER_DRAGON_SPAWN_EGG = register(new Item("ender_dragon_spawn_egg"));
	...
	public static final Item EXPLORER_POTTERY_SHERD = register(new Item("explorer_pottery_sherd"));
	public static final Item EXPOSED_CHISELED_COPPER = register(new Item("exposed_chiseled_copper"));
	public static final Item EXPOSED_COPPER = register(new Item("exposed_copper"));
	public static final Item EXPOSED_COPPER_BULB = register(new Item("exposed_copper_bulb"));
	public static final Item EXPOSED_COPPER_DOOR = register(new Item("exposed_copper_door"));
	public static final Item EXPOSED_COPPER_GRATE = register(new Item("exposed_copper_grate"));
	public static final Item EXPOSED_COPPER_TRAPDOOR = register(new Item("exposed_copper_trapdoor"));
	...
	public static final Item EYE_OF_ENDER = register(new Item("eye_of_ender"));
	...
	public static final Item FIRE = register(new Item("fire"));
	...
	public static final Item FLOWERING_AZALEA_LEAVES = register(new Item("flowering_azalea_leaves"));
	public static final Item FOX_SPAWN_EGG = register(new Item("fox_spawn_egg"));
	public static final Item FRIEND_POTTERY_SHERD = register(new Item("friend_pottery_sherd"));
	public static final Item FROG__SPAWN_EGG = register(new Item("frog__spawn_egg"));
	public static final Item FROGSPAWN = register(new Item("frogspawn"));
	public static final Item FROSTED_ICE = register(new Item("frosted_ice"));
	...
	public static final Item GOAT_HORN = register(new Item("goat_horn"));
	...
	public static final Item GRAY_CANDLE_CAKE = register(new Item("gray_candle_cake"));
	...
	public static final Item GREEN_CANDLE_CAKE = register(new Item("green_candle_cake"));
	...
	public static final Item HEART_POTTERY_SHERD = register(new Item("heart_pottery_sherd"));
	public static final Item HEARTBREAK_POTTERY_SHERD = register(new Item("heartbreak_pottery_sherd"));
	public static final Item HEAVY_CORE = register(new Item("heavy_core"));
	...
	public static final Item IRON_GOLEM_SPAWN_EGG = register(new Item("iron_golem_spawn_egg"));
	...
	public static final Item JUNGLE_BOAT_WITH_CHEST = register(new Item("jungle_boat_with_chest"));
	...
	public static final Item JUNGLE_HANGING_SIGN = register(new Item("jungle_hanging_sign"));
	...
	public static final Item LAVA = register(new Item("lava"));
	public static final Item LAVA_BUCKET = register(new Item("lava_bucket"));
	public static final Item LAVA_CAULDRON = register(new Item("lava_cauldron"));
	...
	public static final Item LIGHT_BLUE_CANDLE_CAKE = register(new Item("light_blue_candle_cake"));
	...
	public static final Item LIGHT_GRAY_CANDLE_CAKE = register(new Item("light_gray_candle_cake"));
	...
	public static final Item LIME_CANDLE_CAKE = register(new Item("lime_candle_cake"));
	...
	public static final Item MAGENTA_CANDLE_CAKE = register(new Item("magenta_candle_cake"));
	...
	public static final Item MANGROVE_BOAT = register(new Item("mangrove_boat"));
	public static final Item MANGROVE_BOAT_WITH_CHEST = register(new Item("mangrove_boat_with_chest"));
	public static final Item MANGROVE_BUTTON = register(new Item("mangrove_button"));
	public static final Item MANGROVE_DOOR = register(new Item("mangrove_door"));
	public static final Item MANGROVE_FENCE = register(new Item("mangrove_fence"));
	public static final Item MANGROVE_FENCE_GATE = register(new Item("mangrove_fence_gate"));
	public static final Item MANGROVE_HANGING_SIGN = register(new Item("mangrove_hanging_sign"));
	public static final Item MANGROVE_LEAVES = register(new Item("mangrove_leaves"));
	public static final Item MANGROVE_LOG = register(new Item("mangrove_log"));
	public static final Item MANGROVE_PLANKS = register(new Item("mangrove_planks"));
	public static final Item MANGROVE_PRESSURE_PLATE = register(new Item("mangrove_pressure_plate"));
	public static final Item MANGROVE_PROPAGULE = register(new Item("mangrove_propagule"));
	public static final Item MANGROVE_ROOTS = register(new Item("mangrove_roots"));
	public static final Item MANGROVE_SIGN = register(new Item("mangrove_sign"));
	...
	public static final Item MELON_STEM = register(new Item("melon_stem"));
	...
	public static final Item MINECART_WITH_CHEST = register(new Item("minecart_with_chest"));
	public static final Item MINECART_WITH_COMMAND_BLOCK = register(new Item("minecart_with_command_block"));
	public static final Item MINECART_WITH_FURNACE = register(new Item("minecart_with_furnace"));
	public static final Item MINECART_WITH_HOPPER = register(new Item("minecart_with_hopper"));
	public static final Item MINECART_WITH_TNT = register(new Item("minecart_with_tnt"));
	public static final Item MINER_POTTERY_SHERD = register(new Item("miner_pottery_sherd"));
	...
	public static final Item MOURNER_POTTERY_SHERD = register(new Item("mourner_pottery_sherd"));
	public static final Item MOVING_PISTON = register(new Item("moving_piston"));
	public static final Item MUD = register(new Item("mud"));
	public static final Item MUD_BRICK_SLAB = register(new Item("mud_brick_slab"));
	public static final Item MUD_BRICK_STAIRS = register(new Item("mud_brick_stairs"));
	public static final Item MUD_BRICK_WALL = register(new Item("mud_brick_wall"));
	public static final Item MUD_BRICKS = register(new Item("mud_bricks"));
	public static final Item MUDDY_MANGROVE_ROOTS = register(new Item("muddy_mangrove_roots"));
	...
	public static final Item MUSIC_DISC_5 = register(new Item("music_disc_5"));
	...
	public static final Item MUSIC_DISC_OTHERSIDE = register(new Item("music_disc_otherside"));
	public static final Item MUSIC_DISC_PIGSTEP = register(new Item("music_disc_pigstep"));
	public static final Item MUSIC_DISC_RELIC = register(new Item("music_disc_relic"));
	...
	public static final Item NETHER_PORTAL = register(new Item("nether_portal"));
	public static final Item NETHER_QUARTZ = register(new Item("nether_quartz"));
	...
	public static final Item OAK_BOAT_WITH_CHEST = register(new Item("oak_boat_with_chest"));
	...
	public static final Item OAK_HANGING_SIGN = register(new Item("oak_hanging_sign"));
	...
	public static final Item OCHRE_FROGLIGHT = register(new Item("ochre_froglight"));
	public static final Item OMINOUS_BANNER = register(new Item("ominous_banner"));
	...
	public static final Item ORANGE_CANDLE_CAKE = register(new Item("orange_candle_cake"));
	...
	public static final Item OXIDIZED_CHISELED_COPPER = register(new Item("oxidized_chiseled_copper"));
	public static final Item OXIDIZED_COPPER = register(new Item("oxidized_copper"));
	public static final Item OXIDIZED_COPPER_BULB = register(new Item("oxidized_copper_bulb"));
	public static final Item OXIDIZED_COPPER_DOOR = register(new Item("oxidized_copper_door"));
	public static final Item OXIDIZED_COPPER_GRATE = register(new Item("oxidized_copper_grate"));
	public static final Item OXIDIZED_COPPER_TRAPDOOR = register(new Item("oxidized_copper_trapdoor"));
	...
	public static final Item PACKED_MUD = register(new Item("packed_mud"));
	...
	public static final Item PEARLESCENT_FROGLIGHT = register(new Item("pearlescent_froglight"));
	...
	public static final Item PINK_CANDLE_CAKE = register(new Item("pink_candle_cake"));
	...
	public static final Item PINK_PETALS = register(new Item("pink_petals"));
	...
	public static final Item POLISHED_TUFF = register(new Item("polished_tuff"));
	public static final Item POLISHED_TUFF_SLAB = register(new Item("polished_tuff_slab"));
	public static final Item POLISHED_TUFF_STAIRS = register(new Item("polished_tuff_stairs"));
	public static final Item POLISHED_TUFF_WALL = register(new Item("polished_tuff_wall"));
	...
	public static final Item POTATOES = register(new Item("potatoes"));
	public static final Item POTION = register(new Item("potion"));
	public static final Item POTTED_ACACIA_SAPLING = register(new Item("potted_acacia_sapling"));
	public static final Item POTTED_ALLIUM = register(new Item("potted_allium"));
	public static final Item POTTED_AZALEA_BUSH = register(new Item("potted_azalea_bush"));
	public static final Item POTTED_AZURE_BLUET = register(new Item("potted_azure_bluet"));
	public static final Item POTTED_BAMBOO = register(new Item("potted_bamboo"));
	public static final Item POTTED_BIRCH_SAPLING = register(new Item("potted_birch_sapling"));
	public static final Item POTTED_BLUE_ORCHID = register(new Item("potted_blue_orchid"));
	public static final Item POTTED_BROWN_MUSHROOM = register(new Item("potted_brown_mushroom"));
	public static final Item POTTED_CACTUS = register(new Item("potted_cactus"));
	public static final Item POTTED_CHERRY_SAPLING = register(new Item("potted_cherry_sapling"));
	public static final Item POTTED_CORNFLOWER = register(new Item("potted_cornflower"));
	public static final Item POTTED_CRIMSON_FUNGUS = register(new Item("potted_crimson_fungus"));
	public static final Item POTTED_CRIMSON_ROOTS = register(new Item("potted_crimson_roots"));
	public static final Item POTTED_DANDELION = register(new Item("potted_dandelion"));
	public static final Item POTTED_DARK_OAK_SAPLING = register(new Item("potted_dark_oak_sapling"));
	public static final Item POTTED_DEAD_BUSH = register(new Item("potted_dead_bush"));
	public static final Item POTTED_FERN = register(new Item("potted_fern"));
	public static final Item POTTED_FLOWERING_AZALEA_BUSH = register(new Item("potted_flowering_azalea_bush"));
	public static final Item POTTED_JUNGLE_SAPLING = register(new Item("potted_jungle_sapling"));
	public static final Item POTTED_LILY_OF_THE_VALLEY = register(new Item("potted_lily_of_the_valley"));
	public static final Item POTTED_MANGROVE_PROPAGULE = register(new Item("potted_mangrove_propagule"));
	public static final Item POTTED_OAK_SAPLING = register(new Item("potted_oak_sapling"));
	public static final Item POTTED_ORANGE_TULIP = register(new Item("potted_orange_tulip"));
	public static final Item POTTED_OXEYE_DAISY = register(new Item("potted_oxeye_daisy"));
	public static final Item POTTED_PINK_TULIP = register(new Item("potted_pink_tulip"));
	public static final Item POTTED_POPPY = register(new Item("potted_poppy"));
	public static final Item POTTED_RED_MUSHROOM = register(new Item("potted_red_mushroom"));
	public static final Item POTTED_RED_TULIP = register(new Item("potted_red_tulip"));
	public static final Item POTTED_SPRUCE_SAPLING = register(new Item("potted_spruce_sapling"));
	public static final Item POTTED_TORCHFLOWER = register(new Item("potted_torchflower"));
	public static final Item POTTED_WARPED_FUNGUS = register(new Item("potted_warped_fungus"));
	public static final Item POTTED_WARPED_ROOTS = register(new Item("potted_warped_roots"));
	public static final Item POTTED_WHITE_TULIP = register(new Item("potted_white_tulip"));
	public static final Item POTTED_WITHER_ROSE = register(new Item("potted_wither_rose"));
	public static final Item POWDER_SNOW = register(new Item("powder_snow"));
	public static final Item POWDER_SNOW_BUCKET = register(new Item("powder_snow_bucket"));
	public static final Item POWDER_SNOW_CAULDRON = register(new Item("powder_snow_cauldron"));
	...
	public static final Item PRIZE_POTTERY_SHERD = register(new Item("prize_pottery_sherd"));
	...
	public static final Item PUMPKIN_STEM = register(new Item("pumpkin_stem"));
	...
	public static final Item PURPLE_CANDLE_CAKE = register(new Item("purple_candle_cake"));
	...
	public static final Item RABBITS_FOOT = register(new Item("rabbits_foot"));
	...
	public static final Item RAW_BEEF = register(new Item("raw_beef"));
	public static final Item RAW_CHICKEN = register(new Item("raw_chicken"));
	public static final Item RAW_COD = register(new Item("raw_cod"));
	...
	public static final Item RAW_MUTTON = register(new Item("raw_mutton"));
	public static final Item RAW_PORKCHOP = register(new Item("raw_porkchop"));
	public static final Item RAW_RABBIT = register(new Item("raw_rabbit"));
	public static final Item RAW_SALMON = register(new Item("raw_salmon"));
	public static final Item RECOVERY_COMPASS = register(new Item("recovery_compass"));
	...
	public static final Item RED_CANDLE_CAKE = register(new Item("red_candle_cake"));
	...
	public static final Item REDSTONE_DUST = register(new Item("redstone_dust"));
	...
	public static final Item SCULK = register(new Item("sculk"));
	public static final Item SCULK_CATALYST = register(new Item("sculk_catalyst"));
	public static final Item SCULK_SENSOR = register(new Item("sculk_sensor"));
	public static final Item SCULK_SHRIEKER = register(new Item("sculk_shrieker"));
	public static final Item SCULK_VEIN = register(new Item("sculk_vein"));
	...
	public static final Item SET_SPAWN = register(new Item("set_spawn"));
	public static final Item SHEAF_POTTERY_SHERD = register(new Item("sheaf_pottery_sherd"));
	...
	public static final Item SHELTER_POTTERY_SHERD = register(new Item("shelter_pottery_sherd"));
	public static final Item SHIELD = register(new Item("shield"));
	public static final Item SHORT_GRASS = register(new Item("short_grass"));
	...
	public static final Item SLIMEBALL = register(new Item("slimeball"));
	...
	public static final Item SMITHING_TEMPLATE_COAST_ARMOR_TRIM = register(new Item("smithing_template_coast_armor_trim"));
	public static final Item SMITHING_TEMPLATE_DUNE_ARMOR_TRIM = register(new Item("smithing_template_dune_armor_trim"));
	public static final Item SMITHING_TEMPLATE_EYE_ARMOR_TRIM = register(new Item("smithing_template_eye_armor_trim"));
	public static final Item SMITHING_TEMPLATE_HOST_ARMOR_TRIM = register(new Item("smithing_template_host_armor_trim"));
	public static final Item SMITHING_TEMPLATE_NETHERITE_UPGRADE = register(new Item("smithing_template_netherite_upgrade"));
	public static final Item SMITHING_TEMPLATE_RAISER_ARMOR_TRIM = register(new Item("smithing_template_raiser_armor_trim"));
	public static final Item SMITHING_TEMPLATE_RIB_ARMOR_TRIM = register(new Item("smithing_template_rib_armor_trim"));
	public static final Item SMITHING_TEMPLATE_SENTRY_ARMOR_TRIM = register(new Item("smithing_template_sentry_armor_trim"));
	public static final Item SMITHING_TEMPLATE_SHAPER_ARMOR_TRIM = register(new Item("smithing_template_shaper_armor_trim"));
	public static final Item SMITHING_TEMPLATE_SILENCE_ARMOR_TRIM = register(new Item("smithing_template_silence_armor_trim"));
	public static final Item SMITHING_TEMPLATE_SNOUT_ARMOR_TRIM = register(new Item("smithing_template_snout_armor_trim"));
	public static final Item SMITHING_TEMPLATE_SPIRE_ARMOR_TRIM = register(new Item("smithing_template_spire_armor_trim"));
	public static final Item SMITHING_TEMPLATE_TIDE_ARMOR_TRIM = register(new Item("smithing_template_tide_armor_trim"));
	public static final Item SMITHING_TEMPLATE_VEX_ARMOR_TRIM = register(new Item("smithing_template_vex_armor_trim"));
	public static final Item SMITHING_TEMPLATE_WARD_ARMOR_TRIM = register(new Item("smithing_template_ward_armor_trim"));
	public static final Item SMITHING_TEMPLATE_WAYFINDER_ARMOR_TRIM = register(new Item("smithing_template_wayfinder_armor_trim"));
	public static final Item SMITHING_TEMPLATE_WILD_ARMOR_TRIM = register(new Item("smithing_template_wild_armor_trim"));
	...
	public static final Item SNIFFER_EGG = register(new Item("sniffer_egg"));
	public static final Item SNIFFER_SPAWN_EGG = register(new Item("sniffer_spawn_egg"));
	public static final Item SNORT_POTTERY_SHERD = register(new Item("snort_pottery_sherd"));
	public static final Item SNOW = register(new Item("snow"));
	public static final Item SNOW_BLOCK = register(new Item("snow_block"));
	public static final Item SNOW_GOLEM_SPAWN_EGG = register(new Item("snow_golem_spawn_egg"));
	...
	public static final Item SOUL_FIRE = register(new Item("soul_fire"));
	...
	public static final Item SPRUCE_BOAT_WITH_CHEST = register(new Item("spruce_boat_with_chest"));
	...
	public static final Item SPRUCE_HANGING_SIGN = register(new Item("spruce_hanging_sign"));
	...
	public static final Item STEAK = register(new Item("steak"));
	...
	public static final Item STRIPPED_BAMBOO_BLOCK = register(new Item("stripped_bamboo_block"));
	...
	public static final Item STRIPPED_CHERRY_LOG = register(new Item("stripped_cherry_log"));
	public static final Item STRIPPED_CHERRY_WOOD = register(new Item("stripped_cherry_wood"));
	...
	public static final Item STRIPPED_MANGROVE_LOG = register(new Item("stripped_mangrove_log"));
	public static final Item STRIPPED_MANGROVE_WOOD = register(new Item("stripped_mangrove_wood"));
	...
	public static final Item SUSPICIOUS_GRAVEL = register(new Item("suspicious_gravel"));
	public static final Item SUSPICIOUS_SAND = register(new Item("suspicious_sand"));
	...
	public static final Item TRIAL_SPAWNER = register(new Item("trial_spawner"));
	public static final Item TRIDENT = register(new Item("trident"));
	public static final Item TRIPWIRE = register(new Item("tripwire"));
	...
	public static final Item TUFF_BRICK_WALL = register(new Item("tuff_brick_wall"));
	public static final Item TUFF_BRICKS = register(new Item("tuff_bricks"));
	public static final Item TUFF_SLAB = register(new Item("tuff_slab"));
	public static final Item TUFF_STAIRS = register(new Item("tuff_stairs"));
	public static final Item TUFF_WALL = register(new Item("tuff_wall"));
	...
	public static final Item VOID_AIR = register(new Item("void_air"));
	public static final Item WALL_TORCH = register(new Item("wall_torch"));
	public static final Item WANDERING_TRADER_SPAWN_EGG = register(new Item("wandering_trader_spawn_egg"));
	public static final Item WARDEN_SPAWN_EGG = register(new Item("warden_spawn_egg"));
	...
	public static final Item WARPED_HANGING_SIGN = register(new Item("warped_hanging_sign"));
	...
	public static final Item WATER_CAULDRON = register(new Item("water_cauldron"));
	public static final Item WAXED_CHISELED_COPPER = register(new Item("waxed_chiseled_copper"));
	public static final Item WAXED_COPPER_BLOCK = register(new Item("waxed_copper_block"));
	public static final Item WAXED_COPPER_BULB = register(new Item("waxed_copper_bulb"));
	public static final Item WAXED_COPPER_DOOR = register(new Item("waxed_copper_door"));
	public static final Item WAXED_COPPER_GRATE = register(new Item("waxed_copper_grate"));
	public static final Item WAXED_COPPER_TRAPDOOR = register(new Item("waxed_copper_trapdoor"));
	...
	public static final Item WAXED_EXPOSED_CHISELED_COPPER = register(new Item("waxed_exposed_chiseled_copper"));
	public static final Item WAXED_EXPOSED_COPPER = register(new Item("waxed_exposed_copper"));
	public static final Item WAXED_EXPOSED_COPPER_BULB = register(new Item("waxed_exposed_copper_bulb"));
	public static final Item WAXED_EXPOSED_COPPER_DOOR = register(new Item("waxed_exposed_copper_door"));
	public static final Item WAXED_EXPOSED_COPPER_GRATE = register(new Item("waxed_exposed_copper_grate"));
	public static final Item WAXED_EXPOSED_COPPER_TRAPDOOR = register(new Item("waxed_exposed_copper_trapdoor"));
	...
	public static final Item WAXED_OXIDIZED_CHISELED_COPPER = register(new Item("waxed_oxidized_chiseled_copper"));
	public static final Item WAXED_OXIDIZED_COPPER = register(new Item("waxed_oxidized_copper"));
	public static final Item WAXED_OXIDIZED_COPPER_BULB = register(new Item("waxed_oxidized_copper_bulb"));
	public static final Item WAXED_OXIDIZED_COPPER_DOOR = register(new Item("waxed_oxidized_copper_door"));
	public static final Item WAXED_OXIDIZED_COPPER_GRATE = register(new Item("waxed_oxidized_copper_grate"));
	public static final Item WAXED_OXIDIZED_COPPER_TRAPDOOR = register(new Item("waxed_oxidized_copper_trapdoor"));
	...
	public static final Item WAXED_WEATHERED_CHISELED_COPPER = register(new Item("waxed_weathered_chiseled_copper"));
	public static final Item WAXED_WEATHERED_COPPER = register(new Item("waxed_weathered_copper"));
	public static final Item WAXED_WEATHERED_COPPER_BULB = register(new Item("waxed_weathered_copper_bulb"));
	public static final Item WAXED_WEATHERED_COPPER_DOOR = register(new Item("waxed_weathered_copper_door"));
	public static final Item WAXED_WEATHERED_COPPER_GRATE = register(new Item("waxed_weathered_copper_grate"));
	public static final Item WAXED_WEATHERED_COPPER_TRAPDOOR = register(new Item("waxed_weathered_copper_trapdoor"));
	...
	public static final Item WEATHERED_CHISELED_COPPER = register(new Item("weathered_chiseled_copper"));
	public static final Item WEATHERED_COPPER = register(new Item("weathered_copper"));
	public static final Item WEATHERED_COPPER_BULB = register(new Item("weathered_copper_bulb"));
	public static final Item WEATHERED_COPPER_DOOR = register(new Item("weathered_copper_door"));
	public static final Item WEATHERED_COPPER_GRATE = register(new Item("weathered_copper_grate"));
	public static final Item WEATHERED_COPPER_TRAPDOOR = register(new Item("weathered_copper_trapdoor"));
	...
	public static final Item WHITE_CANDLE_CAKE = register(new Item("white_candle_cake"));
	...
	public static final Item YELLOW_CANDLE_CAKE = register(new Item("yellow_candle_cake"));
